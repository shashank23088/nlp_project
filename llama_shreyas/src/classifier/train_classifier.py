...
if __name__=="__main__":
    ...
    TRAIN_BATCH_SIZE = 8
    with open('/home/Shreyas-gupta/project/new/nlp_project/baseline2/data/train_preprocessed.json', 'r') as json_file:
        train_data = json.load(json_file)

    VALID_BATCH_SIZE = 4
    with open('/home/Shreyas-gupta/project/new/nlp_project/baseline2/data/valid_preprocessed.json', 'r') as json_file:
...
#                torch.save(state_dict, f"./classifier/classifier_dataloader.py/suggestion_best_ckpt_epoch={epoch}_valid_loss={round(best_loss, 4)}.ckpt")
                torch.save(state_dict, f"best_ckpt_epoch={epoch}_valid_loss={round(best_loss, 4)}.ckpt")
