...
if __name__=="__main__":
    ...
    TRAIN_BATCH_SIZE = 8
    with open('/home/iiitd/Sajid/NLP_Project/sajid/baseline2/data/train_preprocessed.json', 'r') as json_file:
        train_data = json.load(json_file)

    VALID_BATCH_SIZE = 4
    with open('/home/iiitd/Sajid/NLP_Project/sajid/baseline2/data/valid_preprocessed.json', 'r') as json_file:
    ...
    for epoch in range(start_epoch,start_epoch+ EPOCHS):
        ...
        if valid_loss < best_loss:
                ...
                torch.save(state_dict, f"{checkpoint_dir}/best_ckpt_epoch={epoch}_valid_loss={round(best_loss, 4)}.ckpt")
                print("*" * 10 + f" Saved checkpoint at epoch {epoch} with val loss {round(best_loss, 4)} " + "*" * 10)
