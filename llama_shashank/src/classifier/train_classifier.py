...
if __name__=="__main__":
    ...
    TRAIN_BATCH_SIZE = 8
    with open('../../data/train_preprocessed.json', 'r') as json_file:
        train_data = json.load(json_file)

    VALID_BATCH_SIZE = 4
    with open('../../data/valid_preprocessed.json', 'r') as json_file:
    ...
    for epoch in range(start_epoch,start_epoch+ EPOCHS):
        ...
        if valid_loss < best_loss:
                ...
                torch.save(state_dict, f"./checkpoints/best_ckpt_epoch={epoch}_valid_loss={round(best_loss, 4)}.ckpt")
